...
class SpinKitCircleGrid extends StatefulWidget {
  const SpinKitCircleGrid({
    Key? key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
  ...
  @override
  _SpinKitCircleGridState createState() => _SpinKitCircleGridState();
}

class _SpinKitCircleGridState extends State<SpinKitCircleGrid> with SingleTickerProviderStateMixin {
